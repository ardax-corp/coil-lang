...
pub struct Checker {
    ...
    /// Bare (unqualified) names that appear as a function *value* somewhere
    /// in this compile unit — not just as a direct `Call` target. See
    /// [`crate::typechecking::fn_value_escape`].
