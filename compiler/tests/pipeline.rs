...
#[test]
fn example_perf_for_in_range_value_prints_checksum() {
    let output = run_example("examples/perf/for_in_range_value.hy");
    assert_eq!(output, "12884115456");
}
...
#[test]
fn example_perf_for_in_range_field_prints_checksum() {
    let output = run_example("examples/perf/for_in_range_field.hy");
    assert_eq!(output, "12884115456");
}

#[test]
fn example_perf_for_in_range_array_prints_checksum() {
    let output = run_example("examples/perf/for_in_range_array.hy");
    assert_eq!(output, "12884115456");
}

#[test]
fn example_perf_for_in_iter_prints_checksum() {
    let output = run_example("examples/perf/for_in_iter.hy");
    assert_eq!(output, "12884115456");
}

#[test]
fn example_perf_for_in_iter_range_prints_checksum() {
    let output = run_example("examples/perf/for_in_iter_range.hy");
    assert_eq!(output, "12884115456");
}

#[test]
fn example_perf_for_in_dict_prints_checksum() {
    let output = run_example("examples/perf/for_in_dict.hy");
...
fn example_perf_mir_gvn_divf_prints_checksum() {
    ...
    assert_eq!(output, "21333330666666");
}
