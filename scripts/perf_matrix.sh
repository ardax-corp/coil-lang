...
AOT_ONLY=(numeric operators_loop match_sum option_result field_hot dict_hot array_mut match_enum_loop nbody dict_count for_in_sum gc_churn option_int_churn result_int_churn result_heap_churn)
declare -A EXPECTED=(
    [mandelbrot]=625885
    [tak]=7
    [nsieve]=1900
