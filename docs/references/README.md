...
| [crypto](crypto.md) | Userland package | [coil-crypto](https://github.com/ardax-corp/coil-crypto) — hashes / AEAD via `dload` |
...
| [coil-crypto](https://github.com/ardax-corp/coil-crypto) | Userland | hashes / AEAD — see [crypto](crypto.md) |
