...
| [Specialize refuse](specialize-refuse.md) | Hard walls vs Q6–Q9 ladders / cost gate; B1 entry hygiene; B2 CALL convoy; B3 two-slot CALL; B7 sibling / mutual TailCall |
