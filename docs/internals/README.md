...
| [Denser MIR leftovers](mir-dense-leftovers.md) | Post A0–C3 kick list (D0 keep-rate landed for `nsieve`; class `new` maps; dense field; Q9 `main`; multi-payload match) |
