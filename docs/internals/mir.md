...
incoming def past the last use of the φ dest so dense emit’s latch
overwrite can drop the copy. No new opcode; LOAD/STORE cost 2 vs
`DenseMove` 1 is unchanged.
